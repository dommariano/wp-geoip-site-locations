...
function geoipsl_custom_wp_admin_style() {
	wp_register_style( 'geoipsl_custom_wp_admin_css', plugin_dir_url( __FILE__ ) . 'css/admin.css' );
	wp_enqueue_style( 'geoipsl_custom_wp_admin_css' );
}

add_action( 'admin_enqueue_scripts', 'geoipsl_custom_wp_admin_style' );
